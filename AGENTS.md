...
- **Storability gate + revenue-weighted dynamic region + semantic gates + seed suite + fail-fast TTS** → see `docs/PIPELINE_CONVERGED_PLAN.md` (SHIPPED & VERIFIED).
